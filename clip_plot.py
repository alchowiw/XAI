...
texts = ["an image of a dog","an image of a cat"]
...
for i in range(batch_size):
  html = show_heatmap_on_text(texts[i], text[i], R_text[i])
  print(html.data)
  save_html_to_file(html, 'output.html')
  fig = show_image_relevance(R_image[i], img, orig_image=Image.open(img_path))
  fig.suptitle(f'CLIP similarity score of {texts[i]}: {logits_per_image[0,i].item()}')
  plt.show()